...
const yourUrl = "/api/admin/getCompletedNegotiationsDetails";

// Make a GET request to fetch negotiation data from the specified URL
fetch(yourUrl)
  ...
  .then((res) => {
    ...
    let myarray = res; // Store the fetched data in the myarray variable
