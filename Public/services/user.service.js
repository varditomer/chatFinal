...
function goToHomePage() {
    ...
    if (userType === "mediator") {
        ...
        if (urlPath === "/pages/system-reports/print-users-list/printuserslist.html" || urlPath === "/pages/system-reports/opened-negotiations/openNegotiation.html" || urlPath === "/pages/finishednegotiation/finishednegotiation.html"|| urlPath=== "/pages/usernegotiations/usernegotiations.html") {
